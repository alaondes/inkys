            ...
            <div className="p-6 border border-gray-100 rounded-xl bg-gray-50/50 space-y-4">
              ...
              <div className="space-y-6">
                {(storefrontSettings.heroBanners || []).map((banner, index) => (
                  <div key={banner.id || index} className="p-6 border border-gray-100 rounded-2xl bg-white shadow-sm hover:shadow-md transition-all duration-300 relative group">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-4 mb-6 border-b border-gray-100 gap-3">
                      ...
                      <button 
                        ...
                        className="text-red-500 hover:text-white hover:bg-red-500 bg-red-50 px-3 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border border-red-100"
                          ...
                          <div className="relative aspect-[21/9] bg-slate-200 rounded-xl overflow-hidden border-2 border-dashed border-slate-300 hover:border-violet-400 group/img transition-colors cursor-pointer">
                            {banner.image ? (
                              ...
                              <div className="absolute inset-0 flex flex-col items-center justify-center text-slate-400 bg-slate-100">
                                <Image size={32} className="opacity-40 mb-1" />
                            ...
                            <label className="flex items-center justify-center gap-1.5 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-3 py-2 rounded-xl text-xs font-bold cursor-pointer transition-colors shadow-sm">
                              ...
                              <input type="file" className="hidden" accept="image/*" onChange={async (e) => {
                                ...
                                if (file) {
                                  ...
                                  } catch (error) { console.error("Upload error:", error); toast.error("Erro ao carregar imagem"); }
                                }
                              }} />
                            </label>
                          </div>
                          ...
                          <div className="mt-4">
                            ...
                            {banner.image?.startsWith('data:') && (
                              <button 
                                ...
                                className="text-[10px] text-red-500 hover:underline mt-1 font-semibold block text-right ml-auto"
                              >
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            ...
                            <div className="space-y-1">
                              ...
                              <select value={banner.titleSize || 'text-3xl'} onChange={e => {
                                ...
                                setStorefrontSettings({...storefrontSettings, heroBanners: newBanners});
                              }} className="w-full bg-white border border-slate-200 rounded-xl p-2 text-xs focus:border-violet-500 focus:ring-1 focus:ring-violet-500 outline-none shadow-sm h-9">
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            ...
                            <div className="space-y-1">
                              ...
                              <select value={banner.subtitleSize || 'text-xl'} disabled={banner.subtitleSameSize} onChange={e => {
                                ...
                                setStorefrontSettings({...storefrontSettings, heroBanners: newBanners});
                              }} className="w-full bg-white border border-slate-200 rounded-xl p-2 text-xs focus:border-violet-500 focus:ring-1 focus:ring-violet-500 outline-none shadow-sm h-9 disabled:opacity-50 disabled:bg-slate-100">
