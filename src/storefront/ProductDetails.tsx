      ...
      <div className="max-w-[1200px] mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-start">
          ...
          <div className="w-full md:w-[40%]">
            ...
            {product.observation && (
              <div className="w-full mb-4 bg-gray-50 border border-gray-100 rounded-lg py-3 px-4 text-sm text-gray-600 shadow-sm flex items-center gap-3">
                <div className="bg-gray-200/50 p-2 rounded-full shrink-0">
